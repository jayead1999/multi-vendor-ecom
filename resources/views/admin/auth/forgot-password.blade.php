...
<html lang="en">
  <head>
    ...
    <link href="{{asset('assets/admin/css/tabler-flags.css')}}" rel="stylesheet" />
    <link href="{{asset('assets/admin/css/tabler-socials.css')}}" rel="stylesheet" />
    <link href="{{asset('assets/admin/css/tabler-payments.css')}}" rel="stylesheet" />
    <link href="{{asset('assets/admin/assets/css/tabler-vendors.css')}}" rel="stylesheet" />
    <link href="{{asset('assets/admin/assets/css/tabler-marketing.css')}}" rel="stylesheet" />
    <link href="{{asset('assets/admin/assets/css/tabler-themes.css')}}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
  ...
  <body>
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{ route('admin.password.email') }}" method="post" autocomplete="off" novalidate>
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input id="email" type="email" class="form-control" placeholder="Enter email" name="email" autofocus/>
        ...
        <div class="text-center text-secondary mt-3">Forget it, <a href="./sign-in.html">send me back</a> to the sign in screen.</div>
      </div>
    </div>
    <div class="settings">
      <a
