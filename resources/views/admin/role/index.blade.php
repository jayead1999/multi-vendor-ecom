                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-secondary text-capitalize">{{ $role->name }}</td>
                                <td class="text-secondary">{{ $role->guard_name }}</td>
                                <td class="text-secondary">{{ $role->created_at->format('d M Y') }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <form action="{{ route('admin.role.delete', $role->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @else
                            <tr>
                                <td colspan="4" class="text-center">Roles variable is empty. Add roles in controller.</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
