                        ...
                        <div class="login_wrap widget-taber-content background-white">
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="post" action="{{ route('register') }}">
                                    ...
                                    {{-- Radio button for selecting User Role --}}
                                    <div class="form-group">
                                        <label class="mb-10 d-block font-weight-bold">Register as:</label>
                                        <div class="custome-radio d-inline-block me-3">
                                            <input class="form-check-input" type="radio"
                                                name="role" id="userTypeUser" value="user"
                                                 />
                                            <label class="form-check-label" for="userTypeUser">User</label>
                                        </div>
                                        <div class="custome-radio d-inline-block">
                                            <input class="form-check-input" type="radio"
                                                name="role" id="userTypeVendor" value="vendor"
                                               />
