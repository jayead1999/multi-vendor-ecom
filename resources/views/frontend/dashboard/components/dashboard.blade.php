 <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
     <div class="card">
         ...
         @if ($user->profile_picture)
             <img src="{{ asset($user->profile_picture) }}" width="120" class="mb-2 border border-red rounded-circle" alt="Profile Picture">
         @endif
         ...
         <div class="card-body p-0">
             <p>
                 From your account dashboard. you can easily check &amp; view your <a href="#">recent
                     orders</a>,<br />
                 manage your <a href="#">shipping and billing addresses</a> and <a href="#">edit your
