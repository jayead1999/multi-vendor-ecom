  <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
      <div class="container-fluid">
          ...
          <div class="navbar-brand navbar-brand-autodark">
              <a href="." aria-label="Tabler"><svg xmlns="http://www.w3.org/2000/svg" width="110"
          ...
          <div class="navbar-nav flex-row d-lg-none">
              ...
              <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <a href={{ route('vendor.profile') }} class="dropdown-item">PProfile</a>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
              ...
              <ul class="navbar-nav pt-lg-3">
                  ...
                  <!-- Store  -->
                  <li class="nav-item">
                      <a class="nav-link" href={{ route('vendor.store.index') }}>
                          <span
                              class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  ...
                  <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                          ...
                          <span class="nav-link-title"> Edit name </span>
                      </a>
                          ...
                          <div class="dropdown-menu-columns">
                              <div class="dropdown-menu-column">
                                  ...
                                  <div class="dropend">
                                      ...
                                      <div class="dropdown-menu">
                                          <a href="./sign-in.html" class="dropdown-item">2.1</a>
                                      </div>
                                  </div>
